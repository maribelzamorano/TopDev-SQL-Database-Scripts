...
--insert into akkradm.IO_UNTERGRUPPE(VESG_ID,UGAR_ID,UNGR_THEMA,UNGR_DT_BEGINN,UNGR_DT_ENDE,
--	UNGR_MAX_TEILNEHMER,UNGR_#DT_BEGINN_ZEIT,UNGR_#DT_ENDE_ZEIT,UNGR_KZ_GESPERRT,UNGR_KZ_ANMELDUNG_ZUL,
--	UNGR_KZ_NICHT_UEBERBUCHBAR,UNGR_ANMELDEBLOCK,UNGR_KZ_AUTO_VERGABE,UNGR_TEILNEHMER_ANZAHL ) values(1,2, N'Test','2009-10-02','2009-10-02',1, N'Test',
--	N'Test',1,1,1,4,1,4 );
