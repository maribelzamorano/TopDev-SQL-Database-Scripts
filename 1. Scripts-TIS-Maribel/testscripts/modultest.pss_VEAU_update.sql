...
--update  akkradm.IO_VERANSTALTUNG_AUSWERTUNG set VESG_#BEGINN_ZEIT='Test2' where VEAU_ID=1;
...
set @VEAU_id = 4;
set @VEAU_user = 'MZ';
set	@VEAU_xpts = '2009-10-08 11:32:04.793';
...
set	@VESG_#BEGINN_ZEIT                                = 'Tes2';
set	@VESG_ENDE                                        = '2009-10-08';
set	@VESG_#ENDE_ZEIT                                  = 'Tes2';
set	@VESG_DAUER                                       = 1;
...
set	@VEAU_EVAL_INSTRUMENT                             = 'Test2';
