...
if exists ( select * from sysobjects where id = object_id('tis02o.IO_GRUPPE') and OBJECTPROPERTY(id, 'IsTable') = 1)
begin
	GOTO createView;
--	drop table tis02o.IO_GRUPPE;
end;

create table tis02o.IO_GRUPPE(
...
CREATE UNIQUE INDEX GRUP_IX_01_U ON tis02o.IO_GRUPPE( GRUP_UQID );
CREATE INDEX		GRUP_IX_02	 ON tis02o.IO_GRUPPE( GRUP_KZ_GELOESCHT );
